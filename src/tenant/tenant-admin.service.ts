...
export class TenantAdminService {
  ...
  private async buildDefaultRooms(
    ...
    const baseRoom = {
      ...
      roomImage:
        'uploads/rooms/master/1765303909882-0ddbdd57-804f-4339-842b-1a35b80d06f5.jpeg',
      logo: 'string',
      isEditable: true,
    };

    const roomConfigs = [
      { name: 'lobby', listOrder: 0 },
      { name: 'Toplantı Odası', listOrder: 1 },
      { name: 'Sorunlar', listOrder: 2 },
      { name: 'Başvuru Odası', listOrder: 3 },
    ];
